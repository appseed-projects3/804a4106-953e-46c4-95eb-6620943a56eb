...
- Timestamp: `2022-07-13 03:08`
- Build ID: `804a4106-953e-46c4-95eb-6620943a56eb`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/804a4106-953e-46c4-95eb-6620943a56eb.git
$ cd 804a4106-953e-46c4-95eb-6620943a56eb
```
